...
const EditModel = ({ onEditCallback, data }) => {
  ...
  const onFinish = async (values) => {
    ...
    setIsLoading(true);
    try {
      await request.patch(`/admin/model/${data.id}/update/`, formData);
  ...
  return (
    <>
      ...
      <Modal
        title={
          <span className="text-lg font-medium">Редактировать модель</span>
        }
        style={{ maxWidth: 400 }}
        open={isOpen}
        footer={false}
