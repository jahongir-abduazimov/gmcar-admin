...
const DeleteModel = ({ id, onDeleteCallback, isSubcategory }) => {
  ...
  const handleDelete = async () => {
    setIsLoading(true);
    try {
      await request.delete(`/admin/model/${id}/delete/`);
      onDeleteCallback();
      setIsModalOpen(false);
      ...
      <Modal
        title={
          <span className="text-lg font-medium">
            Вы уверены, что хотите удалить этот модель?
          </span>
        }
        closeIcon={false}
        style={{ maxWidth: 560 }}
      ...
      >
        <div>
          <p className="text-[16px]">
            ...
            удалите эту модель, связанные с ней автомобили также могут быть
            удалены.
          </p>
        </div>
