...
const DeleteBrand = ({ id, onDeleteCallback, isSubcategory }) => {
  ...
  const handleDelete = async () => {
    setIsLoading(true);
    try {
      await request.delete(`/admin/brand/${id}/delete/`);
      onDeleteCallback();
      setIsModalOpen(false);
      ...
      >
        <div>
          <p className="text-[16px]">
            ...
            удалите эту марку, то автомобили, принадлежащие ей, также могут быть
            удалены!
          </p>
        </div>
